...
contract BtcProofUtilsTest is DSTest {
    ...
    function testGetP2SH() public {
        ...
        assertEq(uint160(BtcProofUtils.getP2SH(23, validP2SH)), 0x00ae2f3d4b06579b62574d6178c10c882b91503740);
    ...
    function validate(
        ...
        BtcProofUtils.validatePayment(blockHash, txProof, txOutIx, destScriptHash, sats);
    }
}
